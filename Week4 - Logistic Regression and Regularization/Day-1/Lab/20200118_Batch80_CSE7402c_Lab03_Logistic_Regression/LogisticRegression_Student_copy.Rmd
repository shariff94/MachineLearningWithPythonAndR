...
**NOTE:** Before starting this activity, please remember to clear your environment, you can do that by running the following code chunk
...
# The prediction object takes the probability scores and the original levels for the data as input
